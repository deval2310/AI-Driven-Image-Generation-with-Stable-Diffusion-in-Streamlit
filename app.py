...
# Streamlit UI
st.set_page_config(page_title="AI-Driven Image Generation", layout="centered")
st.title("AI-Driven Image Generation with Stable Diffusion 🖼️")
...
with st.expander("✨ Need ideas? Generate prompts with GPT-2"):
    seed_prompt = st.text_input("Enter a seed for GPT-2 prompt", value="A beautiful landscape with mountains")
